package org.jivesoftware.xiff.data.im
{
	...
	public class RosterItemVO extends EventDispatcher implements Contact
	{
		...
		private var _pasteable:Boolean = false;
		...
		public function set pasteable(pasteable:Boolean):void
		{
			_pasteable = pasteable;
		}
		...
		[Bindable]
		public function get pasteable():Boolean
		{
			return (_online && _pasteable) ? true : false;
		}
